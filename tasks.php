...
div {background-color:#eeeefe; width: 30%; height:160px; border: 1px solid #000080; padding:5px; margin:10px; display:block; float:left;}
</style>
<h1>Užduotys - PHP</h1>
<div id="01">
<h2>Užduotis 1: sugeneruoti atsitiktinį sveikąjį skaičių </h2>
<?php include 'functions/task01.php'; ?>
</div>
<div id="02">
<h2> 2: surasti "vidurinį" iš duotų trijų sveikųjų skaičių </h2>
<?php include 'functions/task02.php'; ?>
</div>
<div id="03">
<h2> 3: sugeneruoti atsitiktinį sveikąjį skaičių tarp 1000 ir  2000</h2>
<?php include 'functions/task03.php'; ?>
</div>
<div id="04">
<h2> 4: pagal pateiktą gimimo dieną ir mėnesį nustatyti zodiako ženklą </h2>
<?php include 'functions/task04.php' ?>
</div>
<div id="05">
<h2> 5: skaičiaus skaitmenis išrikiuoti atvirkščiai</h2>
<?php include 'functions/task05.php'; ?>
</div>
<div id="06">
<h2> 6: nustatyti ar duotas skaičius yra veidrodinis </h2>
<?php include 'functions/task06.php'; ?>
</div>
<div id="07">
<h2> 7: sugeneruoti atsitiktinį 5 raidžių derinį </h2>
<?php include 'functions/task07.php'; ?>
</div>
<div id="08" >
<h2>Užduotis 8: iš pateiktų duomenų: web adreso ir teksto sugeneruoti url </h2>
<?php include 'functions/task08.php'; ?>
</div>
<div id="10" >
